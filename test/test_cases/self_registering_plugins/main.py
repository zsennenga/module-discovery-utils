from test.test_cases import self_registering_plugins
from test.test_cases.self_registering_plugins.plugins.self_registering_plugin import SelfRegisteringPlugin
